...
const CharacterItem = ({ character, onSave, fetchCharacters }: { character: any, onSave: () => void, fetchCharacters: () => void }) => {
      ...
      <div className="pb-4 mb-4 relative">
        <div className="flex justify-between items-center">
          ...
          <div className="text-sm text-gray-300 w-11/12">
            ...
            {creator && <p><strong>Creator:</strong> <FormattedText t={creator} /></p>}
            {creatorNotes && <p><strong>Creator Notes:</strong> <FormattedText t={creatorNotes} /></p>}
            {characterVersion && <p><strong>Character Version:</strong> <FormattedText t={characterVersion} /></p>}
            ...
            {systemPrompt && <p><strong>System Prompt:</strong> <FormattedText t={systemPrompt} /></p>}
            {alternateGreetings && (
              <>
                {alternateGreetings.map((greeting: string, idx: number) =>
                  <p><strong>Alternate Greeting {idx + 1}:</strong> <FormattedText t={greeting} /></p>
                )}
              </>
            )}
